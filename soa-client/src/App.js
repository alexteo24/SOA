...
import {faExclamation, faHome, faKeyboard, faSignOutAlt, faUser, faUserPlus} from "@fortawesome/free-solid-svg-icons";
          ...
          <div>
            {this.state.currentUser &&
              <nav className="navbar navbar-expand custom-navbar">
                <a className="navbar-brand" href="/home">Knock-off Ticket Master</a>
                <div className="navbar-nav ml-auto">
                  ...
                  <Link to="/announcement" className="nav-item nav-link"><FontAwesomeIcon icon={faExclamation}/> Announcement</Link>
